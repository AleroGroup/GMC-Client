...
const _2d0d13de = () => interopDefault(import('../pages/user/dashboard/files/documents.vue' /* webpackChunkName: "pages/user/dashboard/files/documents" */))
...
export const routerOptions = {
  ...
  routes: [{
      ...
      path: "/user/dashboard/files/documents",
      component: _2d0d13de,
      name: "user-dashboard-files-documents"
    }, {
